  ...
  return (
    <>
      <section id="about" className="relative h-[120dvh] w-full">
        ...
        {/* Content */}
        <div className="absolute inset-0 max-w-xs lg:max-w-4xl xl:max-w-6xl mx-auto h-[90%] xl:h-[85%] 2xl:h-[100%] flex flex-col items-center justify-end z-10 ">
            ...
            <Reveal>
              <div className="text-white flex flex-col lg:flex-row justify-between items-center mb-4 lg:mb-8 lg:gap-6">
                <ParaTextSecondary type="about">
                  ...
                  <StaggerdText type="cyan">React</StaggerdText> for the front
                  end and <StaggerdText type="cyan">Express</StaggerdText> with{" "}
                  ...
                  hard work leads to{" "}
                  <StaggerdText type="cyan">Success</StaggerdText>, and my goal
