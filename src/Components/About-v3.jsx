      ...
      >
        ...
        <div className="absolute inset-0 max-w-xs lg:max-w-4xl xl:max-w-6xl mx-auto h-full flex flex-col items-center justify-center z-20">
          <div className="flex flex-col justify-evenly items-center bg-slate-700 bg-opacity-30 backdrop-blur-lg rounded-lg w-full py-8 px-4 lg:py-16 lg:px-8">
            ...
            <div className="text-white grid grid-cols-2 grid-rows-2 justify-between items-center mb-4 lg:mb-10 lg:gap-6">
              <div className="col-span-2  lg:col-span-1">
                <ParaTextSecondary type="about">
                  ...
                  <StaggerdText type="teal">React</StaggerdText> for the front
                  end and <StaggerdText type="teal">Express</StaggerdText> with{" "}
              ...
              <div className="hidden lg:flex justify-center items-center max-w-full">
                <img
                  src="/Techimg.jpg" // Replace with the path to your downloaded image
                  alt="Tech Stack Illustration"
                  className="object-cover w-full lg:w-[60%] h-[20dvh]  rounded-lg shadow-md opacity-80"
                />
              </div>
              ...
              <div className="hidden lg:flex justify-center items-center max-w-full">
                <img
                  src="/Growthimg.jpg" // Replace with the path to your downloaded image
                  alt="Personal Growth and Ambition"
                  className="object-cover w-full lg:w-[60%] h-[20dvh]  rounded-lg shadow-md opacity-80"
                />
              </div>
              ...
              <div className="col-span-2 lg:col-span-1">
                <ParaTextSecondary type="about">
                  ...
                  learning and refining my skills, improving API design,
                  enhancing UI creativity, and making systems more efficient.{" "}
                  <StaggerdText type="teal">Driven</StaggerdText> and{" "}
                  <StaggerdText type="teal">Ambitious</StaggerdText>, I believe
                  hard work leads to{" "}
                  <StaggerdText type="teal">Success</StaggerdText>, and my goal
                  is to keep growing and pushing forward in web development.
                </ParaTextSecondary>
              </div>
            </div>
